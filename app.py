...
def predict_IT():
    ...
    return render_template("predictIT.html", prediction_text = "Your 1st Job is {}{} ".format(prediction, " : {}{}".format(int(aScore), "00%")) if prediction == "Software Engineer / Programmer" or prediction == "Technical Support Specialist" or prediction == "Academician" else "Sad to say your first job is not related to IT/CS.", prediction_text1 = "{}{}".format(prediction1, " : {}{}".format(int(aScore1), "00%")), prediction_text2 = "{}{}".format(prediction2, " : {}{}".format(int(aScore2), "00%")), prediction_text3 = "{}{}".format(prediction3, " : {}{}".format(int(aScore3), "00%")), course_suggestion = "Suggest" if aScore == 00 and int(aScore1) == 00 and aScore2 == 00 and aScore3 == 00 else "") 
